...
<title>Damask Chiavari Cushions| ChiavariChairs.com</title>
<meta name="description" content="Our Taupe and Ivory Damask pattern Chiavari Cushion with ties are made with high density foam cores, stain resistant poly-twill fabric and have reinforced seams at stress points. Don’t throw your cushions away every year – invest in Chiavari Cushions that last!" />
...
<div class="float_l">
    ...
    <h2 class="page_head">Damask Chiavari Cushions</h2>
...
<section id="slip-gallery" class="simplegallery">
    <div class="content">
		<a class="fancybox" rel="damask" href="images/ds1.jpg"><img src="images/ds1.jpg" class="image_1" style="display: inline;" alt=""></a>
        <a class="fancybox" rel="damask" href="images/dm.jpg"><img src="images/dm.jpg" class="image_2" style="display: none;" alt=""></a>
		
		<a class="fancybox" rel="damask" href="images/ds2.jpg"><img src="images/ds2.jpg" class="image_3" style="display: none;" alt=""></a>
    ...
    <div class="thumbnail">
        <div class="thumb">
            <a href="#" rel="1">
                <img src="images/ds1.jpg" id="thumb_1" alt="">
            </a>
        </div>
        <div class="thumb">
            <a href="#" rel="2">
                <img src="images/dm.jpg" id="thumb_2" alt="">
            </a>
        </div>
		
		<div class="thumb">
            <a href="#" rel="3">
                <img src="images/ds2.jpg" id="thumb_3" alt="">
            </a>
        </div>
        <div class="best-chivari-two-buttons" style="float:right;margin: 13px 13px;"><a class="best-chivari-quote-button" href="https://shop.visionfurniture.com/TanIvory-Damask-Chiavari-Cushion-with-Ties_p_56.html">BUY NOW</a></div>
         
    </div>
</section>
</div> 
<div class="slip-cov-left"> 
<p>Damask Chiavari Cushions are available with ties only. This Classic style Chiavari Cushion has a robust zipper, top and bottom piping, reinforced seams and a high-density foam core. These cushion pads are made with a heavy, commercial grade Poly-Twill fabric that is treated with a stain resistant finish. We only use high quality materials to ensure that your cushions with last for years!
<br><br>The classic ivory damask pattern is a great neutral cushion option in a subtle pattern featuring tan, ivory and gold. It is made with a Poly-Twill fabric that is low sheen and stain resistant. </p>
	<br><ul class="cat_ul">
