...
$to=$toemail.','.$replyto.',$email';// HARD-CODED INTO mail() function
$error = '';
$headers="";
...
$messages.="<strong>Full Name (Nombre)</strong>: $name <br>";
...
$messages.="<strong>Inquiry (Preguntas)</strong>: $comments <br>";
$to=$toemail;
...
$subject = "Inquiry from Contact Us form: chiavarichairs.com"; 
//Set who the message is to be sent from
...
$mail->AddCC($bcc_email, 'sonya');
$mail->AddBCC($bcc_email2,'anthony');
