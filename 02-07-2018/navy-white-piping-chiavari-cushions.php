...
<title>Navy with White Piping Chiavari Cushions | ChiavariChairs.com</title>
<meta name="description" content="Our Navy cushion covers with White Piping for Chiavari Chair Cushion are made with high density foam cores, stain resistant poly-twill fabric and have reinforced seams at stress points. Don’t throw your cushions away every year – invest in Chiavari Cushions that last!" />
...
<div class="float_l">
    ...
    <h2 class="page_head">Navy with White Piping Chiavari Cushions</h2>
...
<section id="slip-gallery" class="simplegallery">
    <div class="content">
        <a class="fancybox" rel="damask" href="images/nb2.jpg"><img src="images/nb2.jpg" class="image_1" alt="" style="display: inline;"></a>
        <a class="fancybox" rel="damask" href="images/nb1.jpg"><img src="images/nb1.jpg" class="image_2" style="display: none;" alt=""></a>
    ...
    <div class="thumbnail">
        <div class="thumb">
            <a href="#" rel="1">
                <img src="images/nb2.jpg" id="thumb_1" alt="">
            </a>
        </div>
        <div class="thumb">
            <a href="#" rel="2">
                <img src="images/nb1.jpg" id="thumb_2" alt="">
            </a>
        </div>
         <div class="best-chivari-two-buttons" style="float:right;margin: 13px 13px;"><a class="best-chivari-quote-button" href="https://shop.visionfurniture.com/Navy-Blue-Chiavari-Cushion-with-White-Piping-Ties-on-Sale_p_276.html">BUY NOW</a></div>
...
<p>Navy with White Piping Chiavari Cushions are available with only ties. This Classic style Chiavari Cushion has a robust zipper, top and bottom piping, reinforced seams and a high-density foam core. These cushion pads are made with a heavy, commercial grade Poly-Twill fabric that is treated with a stain resistant finish. We only use high quality materials to ensure that your cushions with last for years!
<br><br>These Navy with White Piping Chiavari Cushions have a subtle nautical feel that can work with many different styles of decor. This cushion is made with a Poly-Twill fabric that is low sheen and has a stain resistant finish. </p>
	<br><ul class="cat_ul">
