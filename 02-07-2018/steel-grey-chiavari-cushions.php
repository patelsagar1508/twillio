...
<title>Steel Grey Chiavari Cushions | ChiavariChairs.com</title>
<meta name="description" content="Our Steel Grey Chiavari Chair Cushion with ties are made with high density foam cores, stain resistant poly-twill fabric and have reinforced seams at stress points. Don’t throw your cushions away every year – invest in Chiavari Cushions that last!" />
...
<div class="float_l">
    ...
    <h2 class="page_head">Steel Grey Chiavari Cushions</h2>
...
<section id="slip-gallery" class="simplegallery">
    <div class="content">
        <a class="fancybox" rel="damask" href="images/chiavari steel grey cushion with ties.jpg"><img src="images/chiavari steel grey cushion with ties.jpg" class="image_1" alt="" style="display: inline;"></a>
    ...
    <div class="thumbnail">
        <div class="thumb">
            <a href="#" rel="1">
                <img src="images/chiavari steel grey cushion with ties.jpg" id="thumb_1" alt="">
            </a>
        </div>
		 <div class="best-chivari-two-buttons" style="float:right;margin: 13px 13px;"><a class="best-chivari-quote-button" href="https://shop.visionfurniture.com/Steel-Grey-Cushion-with-Ties_p_297.html">BUY NOW</a></div>
...
<p>Steel Grey Chiavari Cushions are available with only ties. This Classic style Chiavari Cushion has a robust zipper, top and bottom piping, reinforced seams and a high-density foam core. These cushion pads are made with a heavy, commercial grade Poly-Twill fabric that is treated with a stain resistant finish. We only use high quality materials to ensure that your cushions with last for years!
<br><br>The Steel Grey Chiavari Cushion is a great option if you do not want a classic black and would prefer something less dark. This cushion is made with a Poly-Twill fabric that is low sheen and has a stain resistant finish. </p>
	<br><ul class="cat_ul">
